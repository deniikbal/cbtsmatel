...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel='stylesheet' href='<?= $homeurl ?>/dist/css/AdminLTE.min.css?version=<?php echo filemtime('dist/css/custom.css');?>'/>
    ...
    <link rel='stylesheet' href='<?= $homeurl ?>/dist/css/costum.css?version=<?php echo filemtime('dist/css/custom.css');?>'/>
...
<body class='hold-transition skin-green-light  fixed <?= $sidebar ?>'>
    ...
    <div class='wrapper'>
        <header class='main-header'>
            ...
            <nav class='navbar navbar-static-top' style='background-color:#AB1D1D;box-shadow: 0px 10px 10px 0px rgba(0,0,0,0.1)' role='navigation'>
                ...
                <div class='navbar-custom-menu' style="color:white">
                    <ul class='nav navbar-nav' style="color:white">
                        <li class="visible-xs"><a style="color:white"><?= $siswa['nama'] ?></a></li>
                        <li class='dropdown user user-menu'>
                            ...
                            <ul class='dropdown-menu'>
                                <li class='user-header bg-navy'>
                                    ...
                                    <p>
                                        <?= $siswa['nama'] ?> <br>
                                        <span class='badge bg-green'><?=$siswa['id_kelas']?></span>
                                    </p>
                                </li>
                                <li class='user-footer bg-gray'>
                                    <div class='pull-right'>
                                        <a href='<?= $homeurl ?>/logout.php' class='btn btn-sm bg-red btn-flat'><i class='fas fa-sign-out-alt'></i> Keluar</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
            ...
            <section class='sidebar'>
                ...
                <div class='user-panel'>
                    ...
                    <div class='pull-left info' style='left:65px'>
                        ...
                        ?>
                        <p style="color:white" title="<?= $siswa['nama'] ?>"><?= $nama ?></p>
                        <p><a href='#' style='color:white'><i class='fa fa-circle text-green'></i> online</a>
                        <p><span class="badge bg-red" style="color:white"><?=$siswa['idpk']?></span> <span class="badge bg-green" style="color:white"><?=$siswa['id_kelas']?></span> <span class="badge bg-purple" style="color:white">S-<?=$siswa['sesi']?></span></p>
                    </div>
                </div><br>
                <hr style="margin:0px">
                <ul class='sidebar-menu tree' data-widget='tree'>
                    <li class='header'style="color:white">Main Menu Peserta Ujian</li>
                    <li><a href='<?= $homeurl ?>'><i class='fas fa-tachometer-alt fa-fw' style="color:white"></i> <span style="color:white"> Dashboard</span></a></li>
                    <li><a href='<?= $homeurl ?>/jadwal'><i class='fas fa-calendar fa-fw' style="color:white"></i> <span style="color:white"> Jadwal Ujian</span></a></li>
                    ...
                    <li><a href='<?= $homeurl ?>/hasil'><i class='fas fa-tags fa-fw' style="color:white"></i> <span style="color:white"> Hasil Ujian</span></a></li>
                </ul><!-- /.sidebar-menu -->
            </section>
        </aside>
        <div class='content-wrapper' style='background-image: url(dist/backgroun.jpg);background-size: cover;'>
            <section class='content-header' style="height:102px;z-index:0;background:#ECF0F5">
            </section>
                                                ...
                                                <?php if (in_array($siswa['id_kelas'], $datakelas) or in_array('semua', $datakelas)) : ?>
                                                    ...
                                                    if ($ceknilai == '0') :
                                                        if (strtotime($mapelx['tgl_ujian']) <= time() and time() <= strtotime($mapelx['tgl_selesai'])) :
                                                            ...
                                                            $btntest = "<button data-id='$mapelx[id_ujian]' data-ids='$id_siswa' class='btnmulaitest btn btn-block btn-sm btn-primary'><i class='fas fa-clipboard-check'></i> MULAI</button>";
