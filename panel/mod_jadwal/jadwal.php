            ...
            <div class='modal-body'>
                <form id="formtambahujian" method='post'>
                    ...
                    <div class='form-group'>
                        <div class='row'>
                            <div class='col-md-6'>
                                ...
                                <input type='text' name='tgl_ujian' class='tgl form-control' autocomplete='off'
                                    required='true' />
                            </div>
                            <div class='col-md-6'>
                                <label>Tanggal Waktu Expired</label>
                                <input type='text' name='tgl_selesai' class='tgl form-control' autocomplete='off'
                                    required='true' />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='form-group'>
                        <label></label><br>
                        <label>
                            <input type='checkbox' class='icheckbox_square-red' name='acak' value='1' /> Acak Soal
                        </label>
                        <label>
                            <input type='checkbox' class='icheckbox_square-red' name='acakopsi' value='1' /> Acak Opsi
                        </label>
                        <label>
                            <input type='checkbox' class='icheckbox_square-red' name='token' value='1' /> Token Soal
                        </label>

                        <label>
                            <input type='checkbox' class='icheckbox_square-red' name='hasil' value='1' /> Hasil Tampil
                        </label>
                        <label>
                            <input type='checkbox' class='icheckbox_square-red' name='reset' value='1' /> Reset Login
                        </label>
                        <label>
                            <input type='checkbox' class='icheckbox_square-red' name='ulangkkm' value='1' /> Ulang KKM
                        </label>
                    </div>
                    <div class='modal-footer'>
                        <div class='box-tools btn-group pull-right '>
                            ...
                            <button name='tambahjadwal' class='btn bg-green'><i class='fa fa-save'></i>
                                Simpan</button>
                        </div>
                    </div>
                </form>
        ...
        <div class='box box-danger'>
            <div class='box-header with-border '>
                ...
                <div class='box-tools pull-right '>
                    ...
                    <button class='btn btn-flat bg-green' data-toggle='modal' data-backdrop='static'
                        data-target='#tambahjadwal'><i class='glyphicon glyphicon-plus'></i> <span
                            class='hidden-xs'>Tambah Jadwal</span></button>
                    <?php endif ?>
                </div>
            </div><!-- /.box-header -->
            <div class='box-body'>
                ...
                <div class="col-md-6">
                    <form id='formaktivasi' action="">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="ujian[]" style="width:100%" multiple='true'
                                required>
                                ...
                                <option value="<?= $ujian['id_ujian'] ?>">
                                    <?= $ujian['kode_nama'] . " - " . $ujian['nama'] ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <button name="simpan" class="btn bg-red"><i class='fa fa-save'></i> SAVE ALL</button>
                    </form>
                </div>
                <div class="col-md-4">
                    <div class="box-body">
                        ...
                        <a id="btntoken" href="#"><i class='fa fa-spin'> </i> Refreh Sekarang </a>
...
<div class='row'>
    <div class='col-md-12'>
        <div class='box box-success'>
            <div class='box-header with-border '>
                <h3 class='box-title' style='margin-bottom:10px'><i class="fa fa-calendar"></i> Jadwal Ujian
                </h3>
                    ...
                    ?>
                            ...
                            ?>
                                ...
                                <td style="text-align:center">
                                    <i class="fa fa-tag text-green"></i> <small
                                        class='label bg-orange'><?= $mapel['kode_ujian'] ?></small> &nbsp;
                                    <i class="fa fa-user text-green"></i> <small
                                        class='label bg-red'><?= $mapel['level'] ?></small>
                                    &nbsp;
                                    <i class="fa fa-wrench text-green"></i> <small class='label bg-navy'>
                                        <?php
                            ...
                            ?>
                                ...
                                <td>
                                    <small class='label bg-yellow'>
                                        <?= $mapel['tampil_pg'] ?> Soal / <?= $mapel['lama_ujian'] ?> m /
                                        <?= $mapel['opsi'] ?>
                                        opsi</small>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php
                            if ($mapel['acak'] == 1) {
                                echo "<span class='label bg-green' data-toggle='tooltip' data-placement='top' title='soal acak yes'>Y</span> ";
                            } elseif ($mapel['acak'] == 0) {
                                echo "<span class='label bg-red' data-toggle='tooltip' data-placement='top' title='soal acak no'>N</span> ";
                            }
                            if ($mapel['ulang'] == 1) {
                                echo "<span class='label bg-green' data-toggle='tooltip' data-placement='top' title='acak opsi yes'>Y</span> ";
                            } elseif ($mapel['ulang'] == 0) {
                                echo "<span class='label bg-red' data-toggle='tooltip' data-placement='top' title='acak opsi no'>N</span> ";
                            }
                            if ($mapel['token'] == 1) {
                                echo "<span class='label bg-green' data-toggle='tooltip' data-placement='top' title='token ujian yes'>Y</span> ";
                            } elseif ($mapel['token'] == 0) {
                                echo "<span class='label bg-red' data-toggle='tooltip' data-placement='top' title='token ujian no'>N</span> ";
                            }
                            if ($mapel['hasil'] == 1) {
                                echo "<span class='label bg-green' data-toggle='tooltip' data-placement='top' title='tampilkan nilai yes'>Y</span> ";
                            } elseif ($mapel['hasil'] == 0) {
                                echo "<span class='label bg-red' data-toggle='tooltip' data-placement='top' title='tampilkan nilai no'>N</span> ";
                            }

                            if ($mapel['reset'] == 1) {
                                echo "<span class='label bg-green' data-toggle='tooltip' data-placement='top' title='reset yes'>Y</span> ";
                            } elseif ($mapel['reset'] == 0) {
                                echo "<span class='label bg-red' data-toggle='tooltip' data-placement='top' title='reset no'>N</span> ";
                            }
                            if ($mapel['ulang_kkm'] == 1) {
                                echo "<span class='label bg-green' data-toggle='tooltip' data-placement='top' title='ulang kkm yes'>Y</span> ";
                            } elseif ($mapel['ulang_kkm'] == 0) {
                                echo "<span class='label bg-red' data-toggle='tooltip' data-placement='top' title='ulang kkm no'>N</span> ";
                            }
                            ?>
                                </td>
                                <td style="text-align:center">
                                    <?php
                            if ($mapel['status'] == 1) {
                                echo " <label class='label bg-green'>Aktif</label> <label class='label bg-red'>Sesi $mapel[sesi]</label>";
                            } elseif ($mapel['status'] == 0) {
                                echo "<label class='label bg-red'>Tidak Aktif</label>";
                            }
                            ?></small>
                                </td>
                                <td style="text-align:center">
                                    <small class='label bg-navy'><?=
                                $status
                            ?></small> <br>
                                    <small class='text-green'><i class="fa fa-circle" data-toggle="tooltip"
                                            title="Peserta Online"></i></small>
                            ...
                            ?></small>
                                    <i class="fa fa-circle text-danger" data-toggle="tooltip"
                                        title="Peserta Offline"></i>
                                    <small class='text-navy'><?=
                            ...
                            ?></small>
                                ...
                                <td style="text-align:center">
                                    <div class='btn-grou'>
                                        <a class='btn btn-warning ' data-id="<?= $mapel['id_ujian'] ?>"
                                            data-toggle='modal' data-target="#edit<?= $mapel['id_ujian'] ?>"
                                            title='Edit Waktu Ujian'><i class='fa fa-edit'></i></a>
                                        <a href="?pg=status&id=<?= $mapel['id_ujian'] ?>" class='btn btn-danger '
                                            data-toggle='tooltip' data-placement='top' title='Lihat Status Peserta'><i
                                        ...
                                        <form id="formedit<?= $mapel['id_ujian'] ?>">
                                            <div class='modal-body'>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="tgl form-control" name="tgl_ujian"
                                                        value="<?= $mapel['tgl_ujian'] ?>" aria-describedby="helpId"
                                                        placeholder="">
                                                    <small id="helpId" class="form-text text-muted">Tanggal dan waktu
                                                        ujian
                                                        dibuka</small>
                                                </div>
                                                <div class="form-group">
                                                    <label for="selesaiujian">Waktu Ujian Ditutup</label>
                                                    <input type="text" class="tgl form-control" name="tgl_selesai"
                                                        value="<?= $mapel['tgl_selesai'] ?>" aria-describedby="helpId"
                                                        placeholder="">
                                                    <small id="helpId" class="form-text text-muted">Tanggal dan waktu
                                                        ujian
                                                        ditutup</small>
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-3'>
                                                            ...
                                                            <input type='number' name='lama_ujian'
                                                                value="<?= $mapel['lama_ujian'] ?>" class='form-control'
                                                                required='true' />
                                                        </div>
                                                        <div class='col-md-3'>
                                                            <label>Sesi</label>
                                                            <input type='number' name='sesi'
                                                                value="<?= $mapel['sesi'] ?>" class='form-control'
                                                                required='true' />
                                                        </div>
                                                        <div class='col-md-3'>
                                                            <label>Selesai (menit)</label>
                                                            <input type='number' name='btn_selesai'
                                                                value="<?= $mapel['btn_selesai'] ?>"
                                                                class='form-control' required='true' />
                                                        </div>
                                                        <div class='col-md-3'>
                                                            <label>Pelanggaran (detik)</label>
                                                            <input type='number' name='pelanggaran'
                                                                value="<?= $mapel['pelanggaran'] ?>"
                                                                class='form-control' required='true' />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class='form-group'>
                                                    <label>
                                                        <input type='checkbox' class='icheckbox_square-green'
                                                            name='acak' value='1'
                                                            <?php if ($mapel['acak'] == 1) {echo "checked='true'";} ?> />
                                                        Acak Soal
                                                    </label>
                                                    <label>
                                                        <input type='checkbox' class='icheckbox_square-green'
                                                            name='acakopsi' value='1'
                                                            <?php if ($mapel['ulang'] == 1) {echo "checked='true'";} ?> />Acak
                                                        Opsi
                                                    </label>
                                                    <label>
                                                        <input type='checkbox' class='icheckbox_square-green'
                                                            name='token' value='1'
                                                            <?php if ($mapel['token'] == 1) {echo "checked='true'";} ?> />Token
                                                        Soal
                                                    </label>
                                                    <label>
                                                        <input type='checkbox' class='icheckbox_square-green'
                                                            name='hasil' value='1'
                                                            <?php if ($mapel['hasil'] == 1) {echo "checked='true'";} ?> />
                                                        Hasil
                                                        Tampil
                                                    </label>
                                                    <label>
                                                        <input type='checkbox' class='icheckbox_square-green'
                                                            name='reset' value='1'
                                                            <?php if ($mapel['reset'] == 1) {echo "checked='true'";} ?> />
                                                        Reset
                                                        Login
                                                    </label>
                                                    <label>
                                                        <input type='checkbox' class='icheckbox_square-green'
                                                            name='ulangkkm' value='1'
                                                            <?php if ($mapel['ulang_kkm'] == 1) {echo "checked='true'";} ?> />
                                                        Ulang KKM
                                                    </label>
                                                </div>
                                            </div>
                                            <div class='modal-footer'>
                                                <center>
                                                    <button type="submit" class='btn btn-flat bg-navy' name='simpan'><i
                                                            class='fa fa-save'></i> Ganti Waktu Ujian</button>
                                                </center>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            $("#formedit<?= $mapel['id_ujian'] ?>").submit(function(e) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        iziToast.success({
                                            title: 'Mantap!Jadwal Berhasil Diperbaharui',
                                            message:'',
                                            position: 'topRight'
                                        });
                                        setTimeout(function() {
    ...
    $("#btntoken").click(function() {
        $.ajax({
            ...
            success: function(respon) {
                ...
                iziToast.success({
                    title: 'Mantap!Token Berhasil Diperbaharui',
                    message: '',
                    position: 'topRight'
                });
            }
