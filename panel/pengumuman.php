            ...
            <div class='box box-solid'>
                <div class='box-header with-border'>
                    ...
                    <div class='box-tools pull-right'>
                        <button type='submit' name='simpanpengumuman' class='btn btn-sm bg-green'><i
                                class='fa fa-edit'></i> Simpan</button>
                        <a href='?pg=<?= $pg ?>' class='btn btn-sm bg-maroon'><i class='fa fa-times'></i>Close</a>
                    </div>
                </div><!-- /.box-header -->
                <div class='box-body'>
                    <div class='col-sm-12'>
                    ...
                    <div class='col-sm-12'>
                        <div class='form-group'>
                            ...
                            <input type='radio' name='tipe' value='internal' checked> <span
                                class='text-green'><b>guru</b></span> &nbsp; &nbsp;&nbsp;<input type='radio' name='tipe'
                                value='eksternal'> <span class='text-blue'><b>siswa</b></span>
                        </div>
                    </div>
                    <div class='col-sm-12'>
                        <div class='form-group'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small class='label label-primary'>siswa</label>
                                        <?php else : ?>
                                ...
                                <td align='center'>
                                    <div class=''>
                                        <a><button class='btn bg-maroon btn-flat btn-xs' data-toggle='modal'
                                                data-target="#hapus<?= $pengumuman['id_pengumuman'] ?>"><i
                            ...
                            <?php
                                ...
                                ?>
                            <div class='modal fade' id="hapus<?= $pengumuman['id_pengumuman'] ?>"
                                style='display: none;'>
                                            ...
                                            <form action='' method='post'>
                                                ...
                                                <div class='modal-footer'>
                                                    <div class='box-tools pull-right btn-group '>
                                                        <button type='button' class='btn bg-black btn-sm pull-left'
                                                            data-dismiss='modal'>Close</button>
                                                        <button type='submit' name='hapus'
                                                            class='btn btn-sm bg-green'><i class='fa fa-trash'></i>
                                                            Hapus</button>
                                                    </div>
                                                </div>
                                            </form>
