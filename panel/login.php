...
<head>
    <title>Login Admin | <?= APLIKASI . " v" . VERSI ?></title>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="../dist/bootstrap/css/main.css?version=<?php echo filemtime('../dist/bootstrap/css/main.css');?>">
...
<body style="background-color: #999999;">
    <div class="limiter">
        <div class="container-login100">
            <div class='judul'>&copy; <a href="#" class="txt2 hov1" style="color:white">
                    <b><?= APLIKASI . " v" . VERSI ?></b>
                </a>
            </div>
            <div class='logo hidden-xs'><img class='img img-responsive' style='max-width:200px;'
                    src="<?php echo "$homeurl/$setting[logo]"; ?>" width='100'></div>
            ...
            <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50" style="background-image: url('../dist/img/b.jpg');">
                <form id="form-login" class="validate-form">
                    ...
                    <small class="animated flipInX p-b-50" style="color:white">
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button name='submit' type="submit" class="login100-form-btn">
                                 SIGN-IN <i class="fas fa-sign-in-alt fa-lg" style="margin-left:10px"></i>
                            </button>
                        </div>
