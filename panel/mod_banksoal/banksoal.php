        ...
        <div class='box box-danger'>
            <div class='box-header with-border '>
                ...
                <div class='box-tools pull-right '>
                    ...
                    <button class='btn btn-sm bg-green' data-toggle='modal' data-target='#tambahbanksoal'><i class="fas fa-plus-square fa-lg"></i> <span class='hidden-xs'>Tambah Bank
                            Soal</span></button>
                    <button id='btnhapusbank' class='btn btn-sm bg-red'><i class="fas fa-trash-alt"></i> <span
                    ...
                    <table id='example1' class='table table-bordered table-striped'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><small class='label label-success'><?= $no ?></small></td>
                                <td>
                                    <?php
                                            ...
                                            ?>
                                    <img src="../dist/img/soal.png" width=30 alt="">
                                    ...
                                    <div id="collapseThree<?= $no ?>" class="panel-collapse collapse"
                                        aria-expanded="true">
                                        <div class="box-body">
                                            ...
                                            <p> Guru : <small class='label label-primary'><?= $guruku['nama'] ?></small>
                                            </p>
                                            <p> Soal Agama : <small
                                                    class='label label-success'><?= $mapel['soal_agama'] ?></small></p>
                                            ...
                                            <div class=''>
                                                ...
                                                <a href='?pg=<?= $pg ?>&ac=importsoal&id=<?= $mapel['id_mapel'] ?>'><button
                                                        ...
                                                        Import</button></a>
                                                <a><button class='btn btn-warning btn-sm' data-toggle='modal'
                                                        data-target='#editbanksoal<?= $mapel['id_mapel'] ?>'><i
                                                            class='fa fa-edit'></i> Edit</button></a>
                                                <button class="btn btn-primary btn-sm" data-toggle='modal'
                                                    data-target='#copybanksoal<?= $mapel['id_mapel'] ?>'><i
                                                        class="fas fa-copy    "></i> Copy Bank</button>
                                            </div>
                            ...
                            <div class="modal fade" id="copybanksoal<?= $mapel['id_mapel'] ?>" tabindex="-1"
                                        ...
                                        <form id="formcopybank<?= $mapel['id_mapel'] ?>">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="kodebank"
                                            ...
                                            <div class='modal-body'>
                                                ...
                                                <div class='form-group'>
                                                    ...
                                                    <select name='id_pk[]' class='select2 form-control' required='true'
                                                        ...
                                                        <option value="<?= $pk['id_pk'] ?>" selected><?= $pk['id_pk'] ?>
                                                        </option>"
                                                        <?php else : ?>
            ...
            <form id="formtambahbank">
                <div class='modal-body'>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Kode Bank Soal</label>
                                <input type="text" class="form-control" name="kode" placeholder="Masukan Kode Bank Soal"
                                    required>
                    ...
                    <div class='form-group'>
                        <label>Program Keahlian</label>
                        <select name='id_pk[]' class='form-control select2' multiple="multiple" style='width:100%'
                            required='true'>
                            <option value='semua'>Semua</option>
                            <?php
                                    $pkQ = mysqli_query($koneksi, "SELECT * FROM pk ORDER BY program_keahlian ASC");
                ...
                <div class='modal-footer'>
                    <div class='box-tools btn-group pull-right '>
                        ...
                        <button type='submit' name='tambahsoal' class='btn bg-navy'><i class='fa fa-save'></i>
                            Simpan</button>
                    </div>
                </div>
            </form>
            ...
            <div class='box-header with-border '>
                ...
                <div class='box-tools pull-right '>
                    <a href='?pg=<?= $pg ?>&ac=input&id=<?= $id_mapel ?>&no=1&jenis=1'
                        class='btn btn-sm  bg-blue <?= $hidex ?>'><i class='fa fa-plus'></i><span class='hidden-xs'>
                            Add</span> PG</a>
                    <a href='?pg=<?= $pg ?>&ac=input&id=<?= $id_mapel ?>&no=1&jenis=2'
                        class='btn btn-sm bg-yellow <?= $hide ?>'><i class='fa fa-plus'></i><span class='hidden-xs'>
                            Add</span> Essai</a>
                    <a class='btn btn-sm btn-flat bg-blue' href='mod_banksoal/soal_excel.php?m=<?= $id_mapel ?>'><i
                            class="fas fa-file-excel    "></i><span class='hidden-xs'> Excel</span></a>
                    <button class='btn btn-sm btn-flat bg-green' onclick="frames['frameresult'].print()"><i
                            class='fa fa-print'></i><span class='hidden-xs'> Print</span></button>
                    <button id="btnkosongsoal" data-id="<?= $id_mapel ?>" class='btn btn-sm bg-red'><i
                            class='fa fa-trash'></i><span class='hidden-xs'> Kosongkan </span></button>
                    <iframe name='frameresult' src='mod_banksoal/cetaksoal.php?id=<?= $id_mapel ?>'
            ...
            <div class='box-body'>
                <div class='nav-tabs-custom'>
                    <ul class='nav nav-tabs'>
                        <li class='active'><a aria-expanded='true' href='#detail' data-toggle='tab'><i
                                    class='fa fa-envelope-open'></i> Daftar Soal</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:justify">
                                                ...
                                                <table width=100%>
                                                    <tr>
                                                        <td style="padding: 3px;width: 2%; vertical-align: text-top;">A.
                                                        </td>
                                                        ...
                                                        <td style="padding: 3px;width: 2%; vertical-align: text-top;">C.
                                                        </td>
                                                        <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                            <?php
                                                                    if (!$soal['pilC'] == "") {
                                                        ...
                                                        <td style="padding: 3px;width: 2%; vertical-align: text-top;">E.
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td style="padding: 3px;width: 2%; vertical-align: text-top;">B.
                                                        </td>
                                                        <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                            <?php
                                                                    if (!$soal['pilB'] == "") {
                                                        ...
                                                        <td style="padding: 3px;width: 2%; vertical-align: text-top;">D.
                                                        </td>
                                                        <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                            <?php
                                                                        if (!$soal['pilD'] == "") {
                                        ...
                                        <?php
                                                ...
                                                ?>
                                        <div class='modal fade' id="hapus<?= $soal['id_soal'] ?>"
                                            style='display: none;'>
                                            <div class='modal-dialog'>
                                                <div class='modal-content'>
