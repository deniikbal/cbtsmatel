            ...
            <div class='box box-solid'>
                <div class='box-header with-border bg-blue'>
                    ...
                    <div class='btn-group' style='margin-top:-5px'>
                        <a class='btn btn-sm bg-red'>Nama Mapel </a>
                        <a class='btn btn-sm bg-yellow'><?= $mapel['nama'] ?> </a>
                    </div>
                    <div class='box-tools pull-right btn-group'>

                        <button type='submit' name='simpansoal' onclick="tinyMCE.triggerSave(true,true);"
                            class='btn btn-sm bg-green'><i class='fa fa-save'></i> Simpan</button>
                        <a href='?pg=<?= $pg ?>&ac=lihat&id=<?= $id_mapel ?>' class='btn btn-sm btn-danger'><i
                        ...
                        <div class='col-md-6'>
                            <div class='box box-info'>
                                ...
                                <div class='box-body pad'>
                                    <form>
                                        <textarea id='editor2' name='isi_soal' class='editor1' rows='10' cols='80'
                                            style='width:100%;'><?= $soal['soal'] ?></textarea>
                                    </form>
                                </div>
                            </div>
                            <div class='col-md-6'>
                                ...
                                <div class='panel box box-solid'>
                                    <div class='box-header with-border'>
                                        ...
                                        <div class='box-tools pull-right'>
                                            <label><input type='radio' name='jawaban' value='A' required='true'
                                                    <?= $jwbA ?> /> Pilihan A</label>
                                        </div>
                                    </div>
                                    <div id='collapseOne' class='panel-collapse collapse' aria-expanded='false'
                                        ...
                                        <div class='box-body'>
                                            <div class='form-group'>
                                                <textarea name='pilA'
                                                    class='editor1 pilihan form-control'><?= $soal['pilA'] ?></textarea>
                                            </div>
                                            <div class='form-group'>
                                                <?php
												if ($soal['fileA'] <> '') {
