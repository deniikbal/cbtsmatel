...
<head>
    ...
    <link rel='stylesheet' href='<?= $homeurl ?>/dist/css/skins/skin-green-light.min.css?version=<?php echo filemtime('/dist/css/skins/skin-green-light.min.css'); ?>' />
    ...
    <link rel='stylesheet'
        href='<?= $homeurl ?>/plugins/datatables/extensions/Responsive/css/dataTables.responsive.css' />
...
<body class='hold-transition skin-green-light fixed <?= $sidebar ?>'>
    ...
    <div class='wrapper'>
        <header class='main-header'>
            <a href='?' class='logo' style='background-color:#DDDDDD'>
            ...
            <nav class='navbar navbar-static-top'
                style='background-color:#AB1D1D;box-shadow: 0px 10px 10px 0px rgba(0,0,0,0.1)' role='navigation'>
                    ...
                    <ul class='nav navbar-nav'>
                        ...
                        <li class='dropdown notifications-menu'>
                            <a href='#' class='dropdown-toggle' data-toggle='dropdown' style="color:#fff">
                                <i class="fas fa-desktop fa-lg fa-fw"></i> <span
                                    style='font-size:14px'><?= strtoupper($setting['server']) ?></span>
                            </a>
                        ...
                        <?php endif; ?>
                        <li><a style="color:#fff" href='?pg=informasi'><i class="fas fa-comment-dots fa-lg  "></i></a>
                        </li>
                        <li class='dropdown user user-menu'>
                            <a href='#' class='dropdown-toggle' data-toggle='dropdown'>
                                <img src='<?= $homeurl ?>/dist/img/avatar-6.png' class='user-image' alt='+'>
                                <span style="color:#fff" class='hidden-xs'><?= $pengawas['nama'] ?> &nbsp; <i
                                        class='fa fa-caret-down'></i></span>
                            </a>
                            <ul class='dropdown-menu'>
                                <li class='user-header' style="background-color: #001F3F;">
                                    <?php
                                ...
                                <li class='user-footer' style="background-color:#DDDDDD">
                                    <div class='pull-left'>
                                        <?php
										if ($pengawas['level'] == 'admin') :
											echo "<a href='?pg=pengaturan' class='btn btn-sm bg-green btn-flat'><i class='fa fa-cog fa-spin fa-lg'></i> Pengaturan</a>";
										elseif ($pengawas['level'] == 'guru') :
											echo "<a href='?pg=editguru' class='btn btn-sm bg-green btn-flat'><i class='fa fa-cog fa-lg fa-spin'></i> Edit Profil</a>";
										endif
										?>
                                    </div>
                                    <div class='pull-right'>
                                        <a href='logout.php' class='btn btn-sm bg-red btn-flat'><i
        ...
        <aside class='main-sidebar' style="background-color: #fff">
            ...
            <div class="menu-header">
                <ul>
                    ...
                    <li>
                        <a style="color:#fff" href="logout.php" class="btn-logout"> <span
                                class="fa fa-sign-out-alt fa-2x"></span><br>Keluar</a>
                    </li>
                </ul>
            </div>
            <section class='sidebar' style="background-color:#263238">
                <hr style="margin:0px">
                <hr style="margin:0px">
                <ul class=' sidebar-menu tree data-widget=' tree>
                    ...
                    <li class=' treeview'>
                        ...
                        <ul class='treeview-menu'>
                            ...
                            <li><a href='?pg=sinkron'><i class='fas fa-angle-double-right fa-fw'></i> <span> Sinkron
                                        Pusat</span></a></li>
                            <li><a href='?pg=sinkronset'><i class='fas fa-angle-double-right fa-fw'></i> <span> Sinkron
                                        Setting</span></a></li>
                    ...
                    <li class=' treeview'>
                        ...
                        <ul class='treeview-menu'>
                            <li><a href='?pg=importmaster'><i class='fa fa-upload'></i> <span>Import Data
                                        Master</span><span class='pull-right-container'><small
                                            class='label pull-right bg-green'>new</small></span></a></li>
                            <li><a href='?pg=matapelajaran'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data
                                        Mata Pelajaran</span></a></li>
                            <li><a href='?pg=jenisujian'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data
                                        Jenis Ujian</span></a></li>
                            <li><a href='?pg=pk'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data
                                        Jurusan</span></a></li>
                            <li><a href='?pg=kelas'><i class='fa fa-angle-double-right fa-fw'></i> <span> Data
                                        Kelas</span></a></li>
                            <li><a href='?pg=ruang'><i class='fa fa-angle-double-right fa-fw'></i> <span> Data
                                        Ruangan</span></a></li>
                            <li><a href='?pg=level'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data
                                        Level</span></a></li>
                            <li><a href='?pg=sesi'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data
                                        Sesi</span></a></li>
                            <li><a href='?pg=dataserver'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data
                                        Server</span></a></li>
                        </ul>
                    </li>
                    <?php endif ?>
                    <li class='treeview'><a href='?pg=siswa'><i class="fas fa-user-friends side-menu-icon fa-fw   "></i>
                            <span>Peserta Ujian</span></a></li>
                    <!-- <li class='treeview'>
                    ...
                    <li class='treeview'>
                        <a href='#'><i class="fas fa-envelope-open-text side-menu-icon fa-fw"></i><span> Bank Soal
                            </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i>
                            </span></a>
                        <ul class='treeview-menu'>
                            <li><a href='?pg=banksoal'><i class='fas fa-angle-double-right fa-fw'></i> <span> Daftar
                                        Soal</span></a></li>
                            <li><a href='?pg=filependukung'><i class='fas fa-angle-double-right  fa-fw'></i> <span>File
                                        Pendukung</span></a></li>

                        </ul>
                    </li>
                    <li><a href='?pg=statusall'><i class="fas fa-user-friends side-menu-icon fa-fw    "></i>
                    ...
                    <li class='treeview'>
                        <a href='#'><i class="fas fa-desktop side-menu-icon fa-fw"></i><span> Menu Ujian </span><span
                                class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
                        <ul class='treeview-menu'>
                            <li><a href='?pg=jadwal'><i class='fas fa-angle-double-right fa-fw'></i> <span> Jadwak
                                        Ujian</span></a></li>
                            <li><a href='?pg=reset'><i class='fas fa-angle-double-right  fa-fw'></i> <span>Reset
                                        Ujian</span></a></li>
                    ...
                    <li class='treeview'>
                        <a href='#'><i class="fas fa-file-signature side-menu-icon fa-fw"></i><span> Nilai </span><span
                                class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
                        <ul class='treeview-menu'>
                            <li><a href='?pg=nilaiujian'><i class='fas fa-angle-double-right fa-fw'></i> <span> Hasil
                                        Nilai</span></a></li>
                            <li><a href='?pg=semuanilai'><i class='fas fa-angle-double-right  fa-fw'></i> <span>Semua
                                        Nilai</span></a></li>
                            <?php if ($setting['server'] == 'lokal') : ?>
                            <li><a href='?pg=dataujian'><i class='fas fa-angle-double-right fa-fw'></i> <span>Kirim
                                        Nilai</span></a></li>
                            <?php endif ?>
                        </ul>
                    </li>
                    <li class='treeview'>
                        <a href='#'><i class="fas fa-print side-menu-icon fa-fw"></i><span> Cetak </span><span
                                class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
                        <ul class='treeview-menu'>
                            <li><a href='?pg=absen'><i class='fas fa-angle-double-right fa-fw'></i> <span> Daftar
                                        Hadir</span></a></li>
                            <li><a href='?pg=kartu'><i class='fas fa-angle-double-right fa-fw'></i> <span> Cetak
                                        Kartu</span></a></li>
                            <li><a href='?pg=berita'><i class='fas fa-angle-double-right fa-fw'></i> <span> Berita
                                        Acara</span></a></li>
                        </ul>
                    </li>

                    <li class='treeview'><a href='?pg=pengumuman'><i class="fas fa-bullhorn side-menu-icon fa-fw"></i>
                            <span> Pengumuman</span></a></li>
                    <li class='treeview'>
                        <a href='#'><i class="fas fa-users-cog side-menu-icon fa-fw"></i> <span>Manajemen
                                User</span><span class='pull-right-container'> <i
                                    class='fa fa-angle-down pull-right'></i> </span></a>
                        <ul class='treeview-menu'>
                            <li><a href='?pg=pengawas'><i class='fas fa-angle-double-right fa-fw'></i> <span>Data
                                        Administrator</span></a></li>
                            <li><a href='?pg=guru'><i class='fas fa-angle-double-right fa-fw'></i> <span>Data
                                        Guru</span></a></li>
                            <li><a href='?pg=user'><i class='fas fa-angle-double-right fa-fw'></i> <span>Data
                                        Pengawas</span></a></li>
                        </ul>
                    </li>
                    <li class="header">PENGATURAN</li>
                    <li class='treeview'><a href='?pg=pengaturan'><i class="fas fa-tools side-menu-icon fa-fw"></i>
                            <span>Pengaturan</span></a></li>

                    <?php endif ?>
                    <?php if ($pengawas['level'] == 'guru') : ?>
                    <li class='treeview'><a href='?pg=siswa'><i
                                class="fas side-menu-icon fa-user-friends fa-lg fa-fw"></i> <span>Peserta
                                Ujian</span></a></li>
                    <li><a href='?pg=editguru'><i class="fas side-menu-icon fa-users-cog fa-fw"></i> <span>Profil
                                Saya</span></a></li>
                    <li><a href='?pg=banksoal'><i class="fas side-menu-icon fa-envelope-open-text fa-fw"></i> <span>Bank
                                Soal</span></a></li>
                    ...
                    <li><a href='?pg=jadwal'><i class="fas fa-business-time   side-menu-icon fa-fw"></i> <span> Jadwal
                                Ujian</span></a></li>

                    <li><a href='?pg=nilaiujian'><i class='fas fa-file-signature side-menu-icon fa-fw'></i> <span>Hasil
                                Nilai</span></a></li>
                    <?php if ($pengawas['jabatan'] <> '') { ?>
                    <li class='treeview'>
                        <a href='#'><i class="fas fa-coffee   side-menu-icon fa-fw"></i><span> Wali Kelas</span><span
                                class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
                        <ul class='treeview-menu'>
                            <li><a href='?pg=siswabinaan'><i class='fas fa-angle-double-right fa-fw'></i> <span> Siswa
                                        Binaan</span></a></li>
                            <li><a href='?pg=progress'><i class='fas fa-angle-double-right fa-fw'></i> <span> Progress
                                        Ujian</span></a></li>
                            <li><a href='?pg=rekap'><i class='fas fa-angle-double-right fa-fw'></i> <span> Rekap
                                        Ujian</span></a></li>
                        </ul>
                    </li>
                    <?php } ?>
                    ...
                    <li class='treeview'><a href='?pg=siswa'><i
                                class="fas side-menu-icon fa-user-friends fa-lg fa-fw"></i> <span>Peserta
                                Ujian</span></a></li>
                    <li><a href='?pg=statussiswa'><i class="fas side-menu-icon fa-users-cog fa-fw"></i> <span>Status
                                Peserta</span></a></li>
        ...
        <div class='content-wrapper' style="background: #ecf0f5;">
            <section class='content-header' style="color: black;">
                ...
                <div style='float:right; margin-top:-37px'>
                    <button class='btn  btn-flat  bg-orange'><i class="fas fa-calendar-plus"></i>
                        <?= buat_tanggal('D, d M Y') ?></button>
                    <button class='btn  btn-flat  bg-teal'><i class="fas fa-clock" style="margin-right:4px"></i><span id='waktu'><?= $waktu ?></span></button>
                </div>
    ...
    var autoRefresh = setInterval(
        function() {
            $('#divstatussiswa').load(
                "mod_status/statussiswa.php?id=76310EEFF2B5D3C887F238976A421B638CFEB0942AB8249CD0A29B125C91B3E5"
            );
        }, 5000
    );
    <?php } ?>
    ...
    $(document).ready(function() {
        ...
        $('.idkel').change(function() {
            ...
            $('.linknilai').attr('href', '?pg=nilai&ac=lihat&idu=' + idu + '&idm=' + idm + '&idk=' +
                thisval);
        });
