        ...
        <div class='box box-danger'>
            <div class='box-header with-border '>
                ...
                <div class='box-tools pull-right'>
                    ...
                    <a data-toggle='modal' data-backdrop="static" data-target='#tambahsiswa'
                        class='btn btn-sm bg-green'><i class="fas fa-plus-square fa-lg"></i> <span
                            class='hidden-xs'>Tambah Siswa</span></a>
                    <?php endif; ?>
                    <a href='?pg=uplfotosiswa' class='btn btn-sm bg-red'><i class='fa fa-image fa-lg'></i> <span
                            class='hidden-xs'>Upload Foto</span></a>
                    <a href='mod_siswa/ekspor_siswa.php' class='btn btn-sm bg-navy'><i class='fa fa-download fa-lg'></i>
                        <span class='hidden-xs'>Download Data</span></a>
                    <?php endif ?>
                </div>
            </div><!-- /.box-header -->
            <div class='box-body'>
                                ...
                                <form id='form-tambah' action=''>
                                    ...
                                    <div class='modal-footer'>
                                        <div class='box-tools pull-right btn-group'>
                                            <button type='button' class='btn bg-red pull-left'
                                                data-dismiss='modal'>Close</button>
                                            <button type='submit' name='tambahsiswa' class='btn bg-navy'><i
        ...
        <form id="form-edit" method='post'>
            <div class='box box-success'>
                <div class='box-header with-border'>
                    ...
                    <div class='box-tools pull-right btn-group'>
                        <button type='submit' name='submit' class='btn btn-sm btn-success'><i class='fa fa-check'></i>
                            Simpan</button>
                        <a href='?pg=<?= $pg ?>' class='btn btn-sm btn-danger' title='Batal'><i
                    ...
                    <div class='form-group'>
                        <div class='row'>
                            ...
                            <div class='col-md-6'>
                                <label>Nomor Peserta</label>
                                <input type='text' name='no_peserta' class='form-control'
                                    value="<?= $siswa['no_peserta'] ?>" required='true' />
                            </div>
                        </div>
                    </div>
                    <div class='form-group'>
                    ...
                    <div class='row'>
                        <div class='col-md-6'>
                            <div class='form-group'>
                                <label>Username</label>
                                <input type='text' name='username' class='form-control'
                                    value="<?= $siswa['username'] ?>" required='true' />
                            </div>
                        </div>
                        <div class='col-md-6'>
                            <div class='form-group'>
        ...
        'columns': [{
            ...
            <?php if ($setting['server'] == 'pusat') { ?> {
                ...
                'mRender': function(data) {
                    return '<a class="btn btn-flat btn-xs bg-yellow" href="?pg=siswa&ac=edit&id=' +
                        data + '"><i class="fas fa-edit"></i></a>\n\
                                <a class="btn btn-flat btn-xs bg-maroon hapus" data-id="' + data +
