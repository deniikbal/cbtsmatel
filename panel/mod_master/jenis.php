    ...
    <div class='col-md-12'>
        <div class='box box-danger'>
            <div class='box-header with-border'>
                <h3 class='box-title'><i class='fa fa-file'></i> JENIS UJIAN</h3>
                <div class='box-tools pull-right'>
                    <button class='btn btn-sm bg-green' style='margin-right:5px' data-toggle='modal'
                        data-target='#tambahujian'><i class='fa fa-plus-square'></i> Tambah Ujian</button>
                </div>
            </div><!-- /.box-header -->
            <div class='box-body'>
                <?= $info ?>
                    ...
                    <form action='' method='post'>
                        ...
                        <div class='modal-footer'>
                            <div class='box-tools pull-right btn-group'>
                                ...
                                <button type='submit' name='tambahujian' class='btn btn-sm bg-navy'><i
