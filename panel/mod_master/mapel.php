    ...
    <div class='col-md-12'>
        <div class='box box-danger'>
            <div class='box-header with-border'>
                <h3 class='box-title'> <i class='fa fa-rocket'></i> Mata Pelajaran</h3>
                <div class='box-tools pull-right '>
                    <button class='btn btn-sm bg-green' data-toggle='modal' data-target='#tambahmapel'><i
                            class='fa fa-plus-square'></i> Tambah Mapel</button>
                    <button class='btn btn-sm bg-orange' data-toggle='modal' data-target='#importmapel'><i
                            class='fa fa-upload'></i> Import Mapel</button>
                </div>
            </div><!-- /.box-header -->
            <div class='box-body'>
                    ...
                    <form action='' method='post'>
                        ...
                        <div class='modal-footer'>
                            <div class='box-tools pull-right btn-group'>
                                ...
                                <button type='submit' name='simpanmapel' class='btn bg-navy'><i class='fa fa-save'></i>
                                    Simpan</button>
                            </div>
                        </div>
                    </form>
            ...
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    <form action='' method='post' enctype='multipart/form-data'>
                        ...
                        <p>
                            Sebelum meng-import pastikan file yang akan anda import sudah dalam bentuk Ms. Excel 97-2003
                            Workbook (.xls) dan format penulisan harus sesuai dengan yang telah ditentukan. <br />
                        </p>

                        <a href='template/importdatamapel.xls'> <span class='label label-lg label-danger'>Download
                                Format</span></a>

                        <div class='modal-footer'>
                            <div class='box-tools pull-right btn-group'>
                                <button type='button' class='btn bg-red pull-left' data-dismiss='modal'>Close</button>
                                <button type='submit' name='importmapel' class='btn bg-navy'><i
                                        class='fa fa-upload'></i> Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
