        ...
        <div class='box box-danger'>
            <div class='box-header with-border '>
                ...
                <div class='box-tools pull-right '>
                    <a href='<?= $format ?>' class='btn btn-sm btn-flat btn-success'><i class='fa fa-file-excel-o'></i>
                        Download Format</a>
                    <a href='?pg=siswa' class='btn btn-sm btn-flat btn-success' title='Batal'><i
            ...
            <div class='box-body'>
                ...
                <div class='box box-solid'>
                    <div class='box-body'>
                        <div class='form-group'>
                            <div class='row'>
                                <form id='formsiswa' enctype='multipart/form-data'>
                                    ...
                                    <div class='col-md-4'>
                                        <label>&nbsp;</label><br>
                                        <button type='submit' name='submit' class='btn btn-flat btn-success'><i
                                                class='fa fa-check'></i> Import Data</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class='form-group'>
                            <div class='row'>
                                <form action="" method="post" enctype='multipart/form-data'>
                                    ...
                                    <div class='col-md-4'>
                                        <label>&nbsp;</label><br>
                                        <button type='submit' name='importsiswa' class='btn btn-flat btn-success'><i
                                                class='fa fa-check'></i> Import Data</button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <p>Sebelum meng-import pastikan file yang akan anda import sudah dalam bentuk Ms. Excel 97-2003
                            Workbook (.xls) dan format penulisan harus sesuai dengan yang telah ditentukan.</p>
