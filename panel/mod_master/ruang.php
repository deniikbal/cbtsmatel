									...
									<div class='col-md-12'>
										<div class='box box-danger'>
											<div class='box-header with-border'>
												<h3 class='box-title'> <i class='fa fa-home'></i> Tambah Ruang Ujian</h3>
												<div class='box-tools pull-right'>
												<button class='btn btn-sm bg-green' data-toggle='modal' data-target='#tambahruang'><i class='fa fa-plus-square'></i> Tambah Ruang</button>
												</div>
											</div><!-- /.box-header -->
											<div class='box-body'>
												...
												<div class='modal-body'>
													...
													<div class='modal-footer'>
															<div class='box-tools pull-right btn-group'>
																...
																<button type='submit' name='submit' class='btn bg-navy'><i class='fa fa-check'></i> Simpan</button>
															</div>
													</div>
													</form>
												</div>
