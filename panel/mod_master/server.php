										...
										<div class='box box-danger'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right btn-group'>
													<button class='btn bg-green' data-toggle='modal' data-target='#tambahserver'><i class='fa fa-plus-square'></i> Tambah server</button>
...
echo "
															...
															<div class='box-tools pull-right btn-group'>
																...
																<button type='submit' name='simpanserver' class='btn bg-navy'><i class='fa fa-save'></i> Simpan</button>
															</div>
															</div>
															</form>
															</div>
