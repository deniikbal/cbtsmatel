    ...
    <div class='col-md-12'>
        ...
        <div class='box box-danger'>
            <div class='box-header with-border'>
                <h3 class='box-title'> <i class='fa fa-plus-circle'></i> Data Kelas</h3>
                <div class='box-tools pull-right'>
                    <button class='btn btn-sm bg-green' data-toggle='modal' data-target='#tambahkelas'><i
                            class='fa fa-plus-square'></i> Tambah Kelas</button>
                </div>
            </div><!-- /.box-header -->
            <div class='box-body'>
