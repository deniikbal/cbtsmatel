    ...
    <div class='col-md-12'>
        <div class='box box-danger'>
            <div class='box-header with-border'>
                <h3 class='box-title'> <i class='fa  fa-tags'></i> Level atau Tingkat</h3>
                <div class='box-tools pull-right'>
                    <button class='btn btn-sm bg-green' data-toggle='modal' data-target='#tambahlevel'><i
                            class='fa fa-plus-square'></i> Tambah Level</button>
                </div>
            </div><!-- /.box-header -->
            <div class='box-body'>
                    ...
                    <form action='' method='post'>
                        ...
                        <div class='modal-footer'>
                            <div class='box-tools btn-group pull-right '>
                                ...
                                <button type='submit' name='submit' class='btn bg-navy'><i class='fa fa-save'></i>
                                    Simpan</button>
                            </div>
                        </div>
                    </form>
