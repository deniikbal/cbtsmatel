...
<div class='row'>
    ...
    <div class="col-lg-4">
        <div class="small-box bg-yellow ">
            <div class="inner">
                ...
                <?= $qujian['tampil_pg'] ?> Soal / <?= $qujian['lama_ujian'] ?> menit / <?= $qujian['opsi'] ?>
                opsi</small>
            </div>
            <div class="icon">
                <!-- <i class="fa fa-file"></i> -->
    ...
    <div class="col-lg-2">
        ...
        <iframe name='printabsen' src='mod_status/print_absen.php?id=<?= enkripsi($_GET['id']) ?>'
            style='display:none'></iframe>
        <a role="button" onclick="frames['printabsen'].print()">
            <div class="small-box bg-primary ">
                <div class="inner">
                    <div style="text-align:center">Cetak Absensi</div>
                    <center>
                        <h3><i class="fas fa-fingerprint"></i></h3>
                    </center>
                </div>
                <div class="icon">
                    <!-- <i class="fa fa-file"></i> -->
    ...
    <div class="col-lg-2">
        <a href="?pg=beritaujian&id=<?= enkripsi($_GET['id']) ?>">
            <div class="small-box bg-purple ">
                <div class="inner">
                    <div style="text-align:center"> Cetak Berita Acara</div>
                    <center>
    ...
    <div class="col-lg-2">
        <a href="mod_status/report_excel.php?m=<?= $_GET['id'] ?>">
            <div class="small-box bg-green ">
                <div class="inner">
                    <div style="text-align:center">Cetak Excel Nilai</div>
                    <center>
        ...
        <div class='box box-solid' id="statusfull">
            <div class='box-header with-border'>
                ...
                <div class='box-tools pull-right '>
                    <button type="button" class="btn btn-warning" id="btnselesai"><i class="fas fa-upload    "></i>
                        Selesai Semua</button>
                    <button type="button" class="btn btn-primary" id="btnfull"><i class="fa fa-arrows-alt"></i>
                        FullScreen</button>
                    <button type="button" class="btn btn-primary" id="closefull"><i class="fa fa-times"></i>
                        Close</button>
                </div>
            </div><!-- /.box-header -->
            <div class='box-body'>
                        ...
                        <table id='example1' class='table table-bordered table-striped'>
                            ...
                            <tbody id='divstatus'>
                                ...
                                <tr>
                                    ...
                                    <td><?= $siswa['nama'] ?></td>
                                    <td><?= $kelas['nama'] ?></td>
                                    <td><small class='label bg-red'><?= $nilai['kode_ujian'] ?></small> <small
                                            class='label bg-purple'><?= $mapel['nama'] ?></small> <small
                                            class='label bg-blue'><?= $mapel['level'] ?></small></td>
