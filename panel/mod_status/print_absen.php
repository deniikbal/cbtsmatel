    ...
    <table class='detail'>
        ...
        <tr>
            ...
            <td>
                ...
                TANGGAL : <span
                    style='width:190px;'>&nbsp;<?= strtoupper(buat_tanggal('d M Y', $qujian['tgl_ujian'])) ?></span>
            </td>
            <td>SESI</td>
            <td>:</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td><span
                    style='width:150px;'>&nbsp;<?= buat_tanggal('H:i', $qujian['tgl_ujian']) . " - " . buat_tanggal('H:i', $qujian['tgl_selesai']) ?></span>
            </td>
        </tr>
