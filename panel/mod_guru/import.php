            ...
            <div class='box box-solid'>
                <div class='box-header with-border'>
                    ...
                    <div class='box-tools pull-right '>
                        <button type='submit' name='submit' class='btn btn-sm bg-green'><i class='fa fa-upload'></i>
                            Import</button>
                        <a href='?pg=guru' class='btn btn-sm bg-red' title='Batal'><i class='fa fa-times'></i> Close</a>
                    </div>
                </div><!-- /.box-header -->
                <div class='box-body'>
                    <?= $info ?>
                ...
                <div class='box-footer'>
                    <a href='template/importdataguru.xls'><i class='fa fa-file-excel-o'></i> <span
                            style='text-color:black'></span> Download Format</a>
                </div>
            </div><!-- /.box -->
        </form>
    </div>
