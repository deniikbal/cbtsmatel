...
<table width='100%' align='center' cellpadding='10'>
    <tr>
        ...
        <?php
            ...
            ?>
        <td width='50%'>
            <div style='width:12.4cm;border:1px solid #666;'>
                ...
                <table style="text-align:left; width:100%">
                    <tr>
                        <td style="text-align:center; vertical-align:top; width:40px" rowspan="8">
                            <!--  -->
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="ukuran" valign='top'>
                            <div style="padding-top: 12px; padding-left: 60px;" class="ttd"><img
                                    src='<?php echo '../../dist/img/ttd.png' . '?date=' . time(); ?> ?>' height='60px'>
                            </div>
                        </td>
                    </tr>
