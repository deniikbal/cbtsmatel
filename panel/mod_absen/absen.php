        ...
        <div class='box box-solid'>
            <div class='box-header with-border'>
                ...
                <div class='box-tools pull-right '>
                    <button id='btnabsen' class='btn bg-green' onclick="frames['frameresult'].print()"><i
...
function printabsen() {
    ...
    $('#loadabsen').attr('src', 'mod_absen/print_absen.php?id_sesi=' + idsesi + '&id_ruang=' + idruang + '&id_mapel=' +
        idmapel + '&id_kelas=' + idkelas);
}
...
$("#absensesi").change(function() {
    ...
    $.ajax({
        ...
        data: "mapel_id=" + mapel_id + '&sesi=' + sesi + '&ruang=' +
            ruang, // data yang akan dikirim ke file yang dituju
        success: function(response) { // Ketika proses pengiriman berhasil
