    ...
    <table class='detail'>
        ...
        <tr>
            ...
            <td>
                ...
                TANGGAL : <span
                    style='width:190px;'>&nbsp;<?= strtoupper(buat_tanggal('d M Y', $cektanggal['tgl_ujian'])) ?></span>
            </td>
            <td>PUKUL</td>
            <td>:</td>
            <td><span
                    style='width:150px;'>&nbsp;<?= buat_tanggal('H:i', $cektanggal['tgl_ujian']) . " - " . buat_tanggal('H:i', $cektanggal['tgl_selesai']) ?></span>
            </td>
        </tr>
        <tr>
        ...
        <table width='100%' height='30'>
            <tr>
                ...
                <td style='border:1px solid black;font-weight:bold;font-size:14px;text-align:center;'>
                    <?= strtoupper($setting['nama_ujian']) . " " . $setting['sekolah'] ?></td>
                <td width='5px'>&nbsp;</td>
                <td width='25px' style='border:1px solid black'></td>
            </tr>
        </table>
