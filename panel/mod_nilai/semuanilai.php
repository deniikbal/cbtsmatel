            ...
            <div class='box-body'><?= $info ?>
                ...
                <div class="col-lg-2 ">
                    <div class="small-box bg-red">
                        <div class="inner">
                            <h4 style='text-align:center'><?= $jenis['id_kelas'] ?></h4>
                        </div>
                        <a href="?pg=<?= $pg ?>&ac=lihat&idk=<?= $jenis['id_kelas'] ?>" class="small-box-footer">Lihat
                            Nilai <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
...
<div class='row'>
    <div class='col-md-12'>
        <div class='box box-solid'>
            <div class='box-header with-border'>
                <h3 class='box-title'><i class="fas fa-file-signature fa-fw   "></i> REKAP NILAI KELAS <?= $id_kelas ?>
                </h3>
                <div class='box-tools pull-right'>
                    <a class='btn bg-green' href='mod_nilai/report_excel_all.php?k=<?= $id_kelas ?>'><i
                            class='fa fa-download'></i> Excel</a>
                    <a class='btn bg-red' href='?pg=semuanilai'><i class='fa fa-times'></i> Keluar</a>
                </div>
            </div><!-- /.box-header -->
            <div class='box-body'>
