        ...
        <div class='box box-solid'>
            <div class='box-header with-border'>
                ...
                <div class='box-tools pull-right btn-grou'>
                    <button class='btn bg-yellow' onclick="frames['frameresult'].print()"><i class='fa fa-print'></i>
                        Print</button>
                    <iframe name='frameresult' src='mod_nilai/report.php?m=<?= $id_mapel ?>&k=<?= $id_kelas ?>'
                        style='display:none'></iframe>
                    <a class='btn bg-blue' href='mod_nilai/report_excel.php?m=<?= $id_mapel ?>&k=<?= $id_kelas ?>'><i
                            class='fa fa-download'></i> Download</a>
                    <a class='btn bg-green' href='?pg=jadwal'><i class='fa fa-times'></i> Back</a>
                </div>
            </div><!-- /.box-header -->
            <div class='box-body'>
                <div class="row" style="padding-bottom: 10px;">
                    ...
                    <div class="col-md-3">
                        <select id="pilihmapel" class="form-control select2 ujian">
                            ...
                            <option <?php if ($id_mapel == $uj['id_mapel']) {
                                            ...
                                            } ?> value="<?= $uj['id_mapel'] ?>"><?= $uj['kode'] ?> - <?= $uj['nama'] ?>
                            </option>
                            <?php endwhile; ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <button id="cari_nilai" class="btn bg-red"> <i class='fa fa-laptop'></i> Cari Nilai</button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href='<?= $link2 ?>' class='btn btn-xs btn-success' <?= $ket ?>><i
                                            class='fa fa-eye'></i> lihat</a>
                                    <button class='ulangnilai btn btn-xs btn-danger' data-id="<?= $nilai['id_nilai'] ?>"
                                        <?= $ket ?>><i class='fa fa-recycle'></i> Ulang</button>
                                    <!-- Button trigger modal -->
                                    <?php if ($nilai['jawaban_esai'] <> null) { ?>
                                    <button type="button" class="btn btn-xs btn-primary " data-toggle="modal"
                                        data-target="#modelId<?= $nilai['id_nilai'] ?>">
                                        <i class="fas fa-edit    "></i> Esai
                                    </button>

                                    <!-- Modal -->
                                    <div class="modal fade" id="modelId<?= $nilai['id_nilai'] ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="hidden" class="form-control"
                                                                            name="id" value="<?= $nilai['id_nilai'] ?>">
                                                                        <input style="width: 50px" type="text"
                                                                            class="form-control"
                                                                            name="nesai<?= $nilai['id_nilai'] ?>[<?= $key2 ?>]"
                                                                            value="<?= $nesai[$key2] ?>">
                                                                    </td>
                                                                </tr>
                                                                <?php endforeach; ?>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" id="simpanesai<?= $nilai['id_nilai'] ?>"
                                    ...
                                    <button data-id='<?= $nilai['id_nilai'] ?>'
                                        class='hapus btn btn-xs btn-danger'>Bantu Selesai</button>
                                    <?php  } ?>
                                    <?php endif; ?>
                                </td>
                            </tr>
            ...
            <div class='box-body'>
                <table class='table table-bordered table-striped'>
                    ...
                    <tr>
                        ...
                        <td rowspan='3' style='font-size:30px; text-align:center; width:150'><?= $nilai['nilai_esai'] ?>
                        </td>
                        <td rowspan='3' style='font-size:30px; color:blue; text-align:center; width:150'>
                            <?= $nilai['total'] ?></td>
                    </tr>
                    <tr>
                        <th>Kelas</th>
