...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="dist/css/main.css?version=<?php echo filemtime('dist/css/main.css');?>">
    <!--===============================================================================================-->
    <link rel='stylesheet' href='<?php echo $homeurl; ?>/plugins/sweetalert2/dist/sweetalert2.min.css'>
</head>

<body
    style="background: url('<?= $setting['bc'] ?>');background-size:cover;background-position: center;background-repeat: no-repeat;">
        ...
        <div class="container-login100">
            <div class="animated flipInX wrap-login100" style="padding-top:30px">
                <form id="formlogin" action="ceklogin.php" class="login100-form validate-form">
                    ...
                    <div class="animated flipInX delay-10s p-b-20 " style='text-align:center'>
                        <span>Silahkan Login dengan username dan password yang anda
                            miliki</span>
                    </div>
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            SIGN-IN <i class="fas fa-sign-in-alt fa-lg" style="margin-left:5px; pull-right"></i></button>
                        </div>
