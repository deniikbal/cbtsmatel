...
<div class='box-body'>
    <div class='row'>
        ...
        <?php if ($soal['jenis'] == 2) { ?>
        <div class='col-md-12'>
            <textarea id='jawabesai' name='textjawab' style='height:200px' class='jawabesai form-control'
    ...
    <table width='100%'>
        <tr>
            <td style="text-align:center">
                <button id='move-prev' class='btn  btn-danger'
            ...
            <td style="text-align:center">
                <div id='load-ragu'>
                    <a href='#' class='btn bg-yellow'><input type='checkbox'
                            onclick="radaragu(<?= $id_mapel ?>,<?= $id_siswa ?>,<?= $soal['id_soal'] ?>, <?= $ac ?>)"
                            <?= $ragu = ($jawab['ragu'] == 1) ? 'checked' : ''; ?> /> Ragu <span class='hidden-xs'>-
                            Ragu</span></a>
                </div>
            </td>
            <?php } ?>
            <td style="text-align:center">
                ...
                <button id='move-next' class='btn  btn-primary'
                    onclick="loadsoal(<?= $id_mapel ?>,<?= $id_siswa ?>,<?= $no_next ?>)"><span class='hidden-xs'>Soal
                        Selanjutnya </span><i class='fas fa-chevron-circle-right'></i></button>
                ...
                <button class='done-btn btn btn-danger'><i class="fas fa-flag-checkered    "></i> <span
                        class='hidden-xs'>TEST </span>SELESAI</button>
                <?php } else { ?>
